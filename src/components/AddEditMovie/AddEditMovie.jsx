...
export default function AddEditMovie(props) {
    ...
    const formik = (props.editMovieSelection.id !== undefined) ?
        useFormik({
                ...
                <div id="myModal" className="modal">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            {(props.editMovieSelection.id !== undefined) ? <label className="modal-header-lbl-properties">EDIT MOVIE</label> : <label className="modal-header-lbl-properties">ADD MOVIE</label>}
                            <br /><br />
                            <form id={(props.editMovieSelection.id !== undefined) ? "form-edit-movie" : "form-add-movie"} onSubmit={formik.handleSubmit}>
                                {(props.editMovieSelection.id !== undefined) ?
                                <>
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="submit" className="modal-btn-submit" onClick={submitRequest}>{(props.editMovieSelection.id !== undefined) ? "SAVE" : "SUBMIT"}</button>
                        </div>
                    </div>
                </div>
            </> 
